...
//        properties.put("acks", "all");
        ...
        //自动以发送分区
        properties.put(ProducerConfig.PARTITIONER_CLASS_CONFIG,"demo.ConsumerPartitioner");
...
//                producer.send(new ProducerRecord<String, String>("HelloWorld", msg));
                ...
                producer.send(new ProducerRecord<String, String>("first",msg), (metadata, exception) -> {
                    if (exception==null){
